#title           :HTTP.py
#description     :Script for sending data to InfluxDB endpoint
#author          :Katarzyna Mrugała, Krzysztof Domino
#date            :20201216   
#==============================================================================
...
def pushData(binType,ID,lon,lat,fill,track,timestamp):
    ...
    try:
        ...
        power_key = 6
        rec_buff = ''  
        data_measures=',type="'+binType+'" ID="'+ID+'",long='+lon+',lat='+lat+',fill='+fill+',track="'+track+'" '+timestamp+''
